"""Regression checks for the scalaparse casebook."""
...
from casebook.harness import assert_expected, scalaparse_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(scalaparse_summary(), assert_expected())
